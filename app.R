#**************************************************#
# Malaria Dashboard (MDB)
# Developed By Dr. CP Yadav and Dr. Amit Sharma
#**************************************************#
...
# Shape datasets for the Dashboard
data_india<-st_read("data_long.shp")


# Code for Inter authentication
user_base <- tibble::tibble(
  user = c("Admin1", "Admin2"),
  password = sapply(c("mdb1", "mdb2"), sodium::password_store),
...
ui<- fluidPage(
  ...
  # logout button
    ...
    HTML('<font color="black">'), h1(HTML('<left><img src="icmr33.jpeg" width=250 height=150></left> ', alt="Malaria Dashboard (MDB)"), align="center", HTML('<img src="nvbdcp1.jpeg" width=150 height=150>')), HTML('</font>'),
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            conditionalPanel(condition="input.tabselected==0", HTML('<center><img src="NIMRNew.jpeg" width=240 height=60></center>'), h2("About the Dashboard", br(), align="center") ,  h5("Malaria Dashboard (MDB) enables quick analysis of malaria data. It gives interactive graphs and tables as required by the user.", align="justify"),  h5("\n  This dashboard cannot be distributed or shared or altered without the prior permission of the Director, NIMR. The code for the dashboard is proprietary and cannot be shown or shared with anyone.", align="justify"),br(),
                             ...
                             h4("Dr CP Yadav & Dr Amit Sharma", align="center"),  h5("National Institute of Malaria Research", align="center"), h6("Email : cpyadav123@gmail.com, directornimr@gmai.com", align="center")),
            ...
            conditionalPanel(condition="input.tabselected==1",
                             ...
                             h5(selectInput("variable", h5(strong("Select the Variable")), choices=c("api", "afi", "rt", "spr", "aber", "sfr", "pv", "pf", "total", "pf_per", "bse"), selected = "api")),
            ...
            conditionalPanel(condition="input.tabselected==2",
                             ...
                             h5(selectInput("variable2", h5(strong("Select the Variable")), choices=c("api", "afi", "rt", "spr", "aber", "sfr", "pv", "pf", "total", "pf_per"), selected = "api"))
            ...
            conditionalPanel(condition="input.tabselected==3",
                             HTML('<center><img src="NIMRNew.jpeg" width=380 height=120></center>'),
                             h5(selectInput( "state3", h5(strong("Select the State")), choices = unique(data$state), selected="ASSAM", multiple=TRUE)),
                             h5(selectInput("district3", h5(strong("district")), choices="", multiple=TRUE,selected = unique(data$district))),
                             h5(selectInput("variable3", h5(strong("Select the Variable")), choices=c("api", "afi", "rt", "spr", "aber", "sfr", "pv", "pf", "total", "pf_per"), selected = "api")),
            ...
            conditionalPanel(condition="input.tabselected==4",
                             ...
                             h5(selectInput("variable4x", h5(strong("Select the X Variable")), choices=c("api", "aber", "spr",  "sfr", "pv", "pf", "total", "pf_per", "pv_per"), selected = "api")),
                             h5(selectInput("variable4y", h5(strong("Select the Y Variable")), choices=c("api", "aber", "spr",  "sfr", "pv", "pf", "total", "pf_per", "pv_per"), selected = "spr")),
            ...
            conditionalPanel(condition="input.tabselected==5",
                             ...
                             h5(selectInput("year5", h5(strong("Select the one or more year")), choices=unique(data$year),multiple=TRUE, selected = 2000)),
            ...
            conditionalPanel(condition="input.tabselected==6",
                             HTML('<center><img src="NIMRNew.jpeg" width=380 height=120></center>'),
                             h5(selectInput( "state6", h5(strong("SELECT THE STATE")), choices = unique(data$state), selected="ASSAM", multiple=TRUE)),
                             h5(selectInput("district6", h5(strong("Select the district")), multiple=TRUE, choices="", selected = unique(data$district))),
            ...
            conditionalPanel(condition="input.tabselected==7",
                             ...
                             h5(selectInput("variable7", h5(strong("Select the Variable")), choices=c("api", "api_pv", "afi", "rt", "spr", "aber", "sfr", "pv", "pf", "total", "pf_per"), selected = "api"),
            ...
            conditionalPanel(condition="input.tabselected==8",
                             ...
                             h5(selectInput("variable8", h5(strong("Select the Variable")), choices=c("api", "afi", "rt", "spr", "aber", "sfr", "pv", "pf", "total", "pf_per"), selected = "api")),
            ...
            conditionalPanel(condition="input.tabselected==9",
                             ...
                             h5(selectInput("variable9", h5(strong("Select the Variable")), choices=c("api", "afi", "rt", "spr", "aber", "sfr", "pv", "pf", "total", "pf_per"), selected = "api")),
            ...
            conditionalPanel(condition="input.tabselected==10",
                             ...
                             h5(checkboxGroupInput("year10", h5(strong("SELECT THE YEAR")),choices = unique(data_state$year), selected=data_state$year), align="left")
            ...
            conditionalPanel(condition="input.tabselected==13",
                             ...
                             h5(selectInput("variable13", h5(strong("Select the Variable")), choices=c("api", "afi", "rt", "spr", "aber", "sfr", "pv", "pf", "total", "pf_per"), selected = "api")),
        ...
        mainPanel( 
            ...
            tabsetPanel(type="tab", 
                        ...
                        h5("Data Source : NVBDCP, Govt. of India", align = "right"),
                        h4("Developed by Dr. C.P. Yadav", align = "center"),
                        h5("Scientist B", align = "center"),
                        h6("National Institute of Malaria Research, New Delhi", align = "center")
  ...
  logout_init <- shinyauthr::logoutServer(
    ...
    output$nimr<-renderPlot({
      req(credentials()$user_auth)  
        plot(1:2, type='n', main="WELLCOME", xlab="National Institute of Malaria Research (NIMR), New Delhi", ylab="", xaxt="n",yaxt="n",  cex.lab = 1.4, cex.main=3)
        lim <- par()
      ...
      req(credentials()$user_auth)  
        ...
        if(input$lab5=="Off") {
            ...
            ggplot(reactive5(), aes(x = district, y = freq, group = group, fill = group)) +
                ...
                scale_y_continuous(breaks = pretty(reactive5()$freq),labels = abs(pretty(reactive5()$freq)))+labs(title = "Pv-Pf Distribution")
